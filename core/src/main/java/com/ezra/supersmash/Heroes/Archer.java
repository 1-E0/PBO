...
public class Archer extends Hero {
    ...
    private static AnimationComponent createArcherAnimations() {
        ...
        animations.put(AnimationComponent.HeroState.IDLE, AnimationComponent.createAnimation("characters/archer_idle.png", 8, 0.1f));
        animations.put(AnimationComponent.HeroState.ATTACKING, AnimationComponent.createAnimation("characters/archer_attack.png", 13, 0.08f));
